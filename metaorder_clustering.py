...
def _resolve_output_base(args: argparse.Namespace, cfg: Mapping[str, Any], dataset_name: str) -> Path:
    ...
    return Path(_format_path_template(value, context))
...
def _render_result_visualizations(
    ...
    for stale_name in ["pca_clusters_pc1_pc2.html", "pca_clusters_pc1_pc2.png"]:
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--config-path",
        type=str,
        default="config_ymls/metaorder_computation.yml",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional explicit path for the run log file. Default: <out_dir>/run_<timestamp>.log",
    )
    return parser
...
def main() -> None:
    ...
    >>> # python metaorder_clustering.py --group both --k-min 2 --k-max 12
    """
    ...
    log_path = Path(args.log_file) if args.log_file else out_dir / f"run_{timestamp}.log"
